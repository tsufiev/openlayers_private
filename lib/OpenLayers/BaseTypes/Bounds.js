...
OpenLayers.Bounds = OpenLayers.Class({
     ...
     *     bounds.
     */
    contains:function(x, y, inclusive, noCast) {
        //set default
        if (inclusive == null) {
            inclusive = true;
        }
     ...
     */
    containsBounds:function(bounds, partial, inclusive, noCast) {
        if (partial == null) {
            partial = false;
        }
        if (inclusive == null) {
        ...
        var bottomLeft  = this.contains(bounds.left, bounds.bottom, inclusive, noCast);
        var bottomRight = this.contains(bounds.right, bounds.bottom, inclusive, noCast);
        var topLeft  = this.contains(bounds.left, bounds.top, inclusive, noCast);
        var topRight = this.contains(bounds.right, bounds.top, inclusive, noCast);
